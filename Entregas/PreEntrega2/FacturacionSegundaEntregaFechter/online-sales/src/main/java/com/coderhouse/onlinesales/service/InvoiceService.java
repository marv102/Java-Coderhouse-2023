...
public class InvoiceService {
    ...
    public Invoice createInvoice(InvoiceDTO invoiceDTO){
        ...
        Double total = calculateTotal(invoiceDTO.getInvoiceDetails());
    ...
    public Double calculateTotal(List<InvoiceDetailDTO> invoiceDetails){
        Double total = 0d;
    ...
    public List<InvoiceDetail> getInvoiceDetailsFromDTO(List<InvoiceDetailDTO> invoiceDetailsDTO){
        ...
        for(InvoiceDetailDTO invoiceDetailDTO : invoiceDetailsDTO){
            ...
            Double subtotal = invoiceDetailDTO.getSubtotal();
